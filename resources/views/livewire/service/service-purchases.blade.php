<div>
    ...
    <div class="main-actions">
        ...
        <div class="py-1.5 px-4 bg-white rounded-lg shadow border-b-2 border-red-800">
            <h3 class="text-sm text-gray-600">Total em compras</h3>
            <p class="text-lg font-bold">R$ {{ $sum_purchases }}</p>
        </div>
    </div>
    <div class="card">
                ...
                <tbody>
                    @foreach ($purchases as $purchase)
                        <tr>
                            <td>
                                <a
                                    href="{{ route('purchases.show', $purchase) }}">{{ $purchase->date->format('d/m/Y') }}</a>
                            </td>
                            <td>
